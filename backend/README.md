...
## Project Structure
    ...
    ├── testapiautocatalog_127345  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_127345`
...
2. Clone this repo and `cd testapiautocatalog_127345`
